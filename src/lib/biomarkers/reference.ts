...
export const BIOMARKER_REFERENCES: Record<string, BiomarkerReference> = {
  ...
  neutrophils: {
    ...
    category: 'cbc',
    unit: 'cells/uL',
    standardRange: { min: 1500, max: 7800 },
    optimalRange: { min: 2000, max: 7000 },
    direction: 'mid-range',
  },
  lymphocytes: {
    id: 'lymphocytes',
    ...
    category: 'cbc',
    unit: 'cells/uL',
    standardRange: { min: 850, max: 3900 },
    optimalRange: { min: 1500, max: 3500 },
    direction: 'mid-range',
  },
  monocytes: {
    id: 'monocytes',
